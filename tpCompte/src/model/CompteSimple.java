...
public class CompteSimple {
	...
	private boolean authorizeOperation(int somme, String operationType) {
		boolean authorized = false;
		if (this instanceof CompteVIP) return true;
	...
	public int getCommission() {
		return (this instanceof CompteVIP) ? 0 : commission;
	}
